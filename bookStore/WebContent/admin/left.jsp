			...
			<td>
				<div class="meun_div" align="center">
					...
					<div class="meun_box none_box" id="box1">
						<ul>
							<li><a href="indentList?status=1"  target="rightFrame">&middot;未处理</a></li>
							<li><a href="indentList?status=2"  target="rightFrame">&middot;已处理</a></li>
						</ul>
					</div>
					...
					<div class="meun_box none_box" id="box2">
						<ul>
							<li><a href="userList"  target="rightFrame">&middot;用户列表</a></li>
							<li><a href="userAd"  target="rightFrame">&middot;添加用户</a></li>
						</ul>
					</div>
					...
					<div class="meun_box none_box" id="box3">
						<ul>
							<li><a href="bookList"  target="rightFrame">&middot;图书列表</a></li>
							<li><a href="bookList?status=1"  target="rightFrame">&middot;推荐列表</a></li>
							<li><a href="bookList?status=2"  target="rightFrame">&middot;最新列表</a></li>
							<li><a href="bookList?status=3"  target="rightFrame">&middot;促销列表</a></li>
							<li><a href="bookAd"  target="rightFrame">&middot;添加图书</a></li>
						</ul>
					</div>
					
					<div class="meun_top">
						<div id="img4" class="meun_img"></div>
						<a onclick="show_menu_box(4)" href="javascript:;">分类管理</a>
					</div>
					<div class="meun_box none_box" id="box4">
						<ul>
							<li><a href="categoryList"  target="rightFrame">&middot;分类列表</a></li>
							<li><a href="categoryAd"  target="rightFrame">&middot;添加分类</a></li>
						</ul>
					</div>
					...
					<div class="meun_box none_box" id="box5">
						<ul>
							...
							<li><a href="adminAd"  target="rightFrame">&middot;添加管理员</a></li>
						</ul>
					</div>
