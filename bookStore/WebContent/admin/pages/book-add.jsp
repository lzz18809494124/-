...
<body>
	...
	<form action="bookAdd" method="post" enctype="multipart/form-data">
		...
		封面：<input type="file" name="file" size="12" required="required"/><br>
		书名：<input type="text" name="name" required="required"/><br>
		价格：<input type="text" name="price" required="required"/><br>
		数量：<input type="text" name="count" required="required"/><br>
		介绍：<input type="text" name="intro" required="required"/><br>
		作者：<input type="text" name="auther"/><br>
		出版社：<input type="text" name="press"/><br>
		出版日期：<input type="text" id="datepicker" name="pubdate"/><br>
